...
def load_models():
    return {
        '₹50': load_model('model_50rs_augmented.keras'),
        '₹100': load_model('model_100rs_augmented.keras'),
        '₹500': load_model('model_500rs_augmented.keras'),
        '₹2000': load_model('model_2000rs_augmented.keras')
    }
